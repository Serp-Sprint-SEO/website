...
const features = [
  {
    ...
    description:
      "SERP Sprint offers an all-inclusive SEO solution. We don’t just audit your website; we identify issues and implement every fix, technical and non-technical. We also give expert insights to boost the organic traffic of your website.",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Why should you choose SERP Sprint?
          </h2>
